---
name: intake
description: Internal intake procedure used by the work skill for a new task in a Harness repo. Classify and record the request before clarification or exploration, return the intake id and lane to the work resolver, and do not create a human-copy handoff.
---
...
**Announce at start:** "Classifying this task via Harness intake."
