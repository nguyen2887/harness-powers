...
**Announce at start:** "Done gate: verifying and closing this work."
...
2. **Code-review gate**
   ...
   - **Triage** — verify each finding technically before acting: Critical/Important → fix (re-enter the TDD loop for behavior changes), then re-run the gate. Minor → fix or reject with a one-line technical reason.
