...
**Announce at start:** "Debugging: finding the root cause before any fix."
...
3. Return to where you came from: mid-implementation → back to the **implementing** skill; standalone bugfix → the **done** skill.
