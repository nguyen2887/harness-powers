---
name: done
description: Internal closer procedure dispatched by harness-powers:work at close. Require fresh verification and approved code review, perform durable story and trace bookkeeping, persist the close report, and advance the mailbox to closed.
---

# Close Stage

**Announce at start:** "Using harness-powers:done to close verified and reviewed work."
